...
/*                  creation of Deletion From the end Function             */

struct node *deletion10(struct node *temp1)
{
    struct node *temp2;
    struct node *temp3;
    temp3 = temp1;
...
/*                  creation of Deletion From the end Function finished                 */
...
int main()
{
    ...
    /*                  calling of Deletion From the end function               */
    node1 = deletion10(node1);
    /*                  calling of Deletion From the end function Finished              */
