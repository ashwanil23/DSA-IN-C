...
/*                  creation of Deletion From the Specified Position Function             */

struct node *deletion05(struct node *temp1, int index)
{
    struct node *temp2;
    struct node *temp3;
    temp3 = temp1;
...
/*                  creation of Deletion From the Specified Position Function finished                 */
...
int main()
{
    ...
    /*                  calling of Deletion From the Specified Position function               */
    node1 = deletion05(node1, 5);
    /*                  calling of Deletion From the Specified Position function Finished              */
